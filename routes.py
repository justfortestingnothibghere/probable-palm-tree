...
def index():
    ...
    return render_template('../index.html')  # Root index.html
...
def search():
    if request.method == 'POST':
        ...
        ydl_opts = {'quiet': True, 'default_search': 'ytsearch10'}  # Top 10 results
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
...
def share_redirect(share_id):
    video_id = share_id  # Simple mapping, use DB for production
